...
public class KitchenController {
    ...
    // Iniettiamo i due controller figli
    @FXML
    ...
    public void initialize() {
        ...
        // carico gli ordini dove c'e' almeno un ordine della cucina
        List<RestaurantOrder> kitchenOrders = service.getOrdersByCategory("KITCHEN");
